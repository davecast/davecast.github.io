<template>
  <section class="section section__no--top section__bottom__100">
    <div class="container">
      <div class="contact">
...
import DcInput from "@/components/commons/DcInput.vue";
...
.contact__form {
  ...
  grid-template-areas:
    "name name name name name name last last last last last last"
